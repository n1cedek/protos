...
func (x *RegisterResponse) GetIdUser() int64 {
	if x != nil {
		return x.IdUser
	}
	return 0
...
type LoginRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               //to login
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         //to login
	AppId         int32                  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` //приложение в которое логинится пользователь
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x06, 0x69, 0x64, 0x55, 0x73, 0x65, 0x72, 0x22, 0x57, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x5a, 0x14, 0x6e, 0x31, 0x63, 0x65, 0x64, 0x65, 0x6b, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31,
